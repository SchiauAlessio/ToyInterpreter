...
import com.toy.interpreter.Model.commands.ExitCommand;
...
//        run();
        ...
        try {
            ...
            repo1.setFile("src\\main\\java\\com\\exam\\exam\\Data\\1.out");
            Controller ctrl1 = new Controller(repo1);
        ...
        try {
            ...
            repo2.setFile("src\\main\\java\\com\\exam\\exam\\Data\\2.out");
            Controller ctrl2 = new Controller(repo2);
        ...
        try{
            ...
            repo3.setFile("src\\main\\java\\com\\exam\\exam\\Data\\3.out");
            Controller ctrl3 = new Controller(repo3);
        ...
        try{
            ...
            repo4.setFile("src\\main\\java\\com\\exam\\exam\\Data\\4.out");
            Controller ctrl4 = new Controller(repo4);
        ...
        //int varc;readFile(varf,varc);print(varc); readFile(varf,varc);print(varc)   closeRFile(varf)
        IStmt ex5 = new CompStmt(new VarDeclStmt("varf",new StringType()),
                new CompStmt(new AssignStmt("varf", new ConstExp(new StringValue("src\\main\\java\\com\\exam\\exam\\Data\\test.in"))),
                        new CompStmt(new openRFile(new VarExp("varf")),
                                new CompStmt(new VarDeclStmt("varc",new IntType()),
                                        new CompStmt(new readFile(new VarExp("varf"), "varc"),
                                                new CompStmt(new PrintStmt(new VarExp("varc")),
        ...
        try{
            ...
            repo5.setFile("src\\main\\java\\com\\exam\\exam\\Data\\5.out");
            Controller ctrl5 = new Controller(repo5);
        ...
        try {
            ...
            repo6.setFile("src\\main\\java\\com\\exam\\exam\\Data\\6.out");
        ...
        try{
            ...
            repo7.setFile("src\\main\\java\\com\\exam\\exam\\Data\\7.out");
        ...
        try{
            ...
            repo8.setFile("src\\main\\java\\com\\exam\\exam\\Data\\8.out");
        ...
        try{
            ...
            repo9.setFile("src\\main\\java\\com\\exam\\exam\\Data\\9.out");
        ...
        try{
            ...
            repo10.setFile("src\\main\\java\\com\\exam\\exam\\Data\\10.out");
        ...
        try{
            ...
            repo11.setFile("src\\main\\java\\com\\exam\\exam\\Data\\11.out");
